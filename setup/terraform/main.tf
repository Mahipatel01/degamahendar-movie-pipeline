...
# Track the latest Amazon Linux 2023 release for the EKS version.
#
# IMPORTANT:
# Terraform AWS provider v4.55.0 does not support
# ami_type = "AL2023_x86_64_STANDARD", so ami_type is
# intentionally not specified below.
...
# The original project attempted to create an inline IAM user policy:
#
...
# }
#
# The Cloud Gateway role does not have iam:PutUserPolicy permission,
# so that resource is intentionally omitted.
